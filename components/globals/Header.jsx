...
import LiftedWPBanner from "../../public/images/GrapeCover.png";
import nickimg from "../../public/images/nick-img.jpg";

const profile = {
  name: "Nick Kouroumpetsis",
  role: "Free Lancer & Junior Developer",
  companyURL: "https://nkcompany.gr",
  companyName: "nkcompany.gr",
  email: "nikolaos.kouroumpetsis@gmail.com",
  message:
    "Hey there, If you ever need my services on your company, I'd love to contact me!",
  callToActionURL:
    "https://gr.linkedin.com/in/nikolaos-kouroumpetsis-363819220",
  callToActionMessage: "Send me a message",
  profileImage: nickimg,
